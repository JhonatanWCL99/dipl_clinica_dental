...
<div class="row s12">
    ...
    <div class="col s6 right-align ">
        <a href="<?php echo "http://localhost/ExamenFinal" ?>/app/views/odontologo/registrar.php" class="btn btn-#01579b light-blue darken-4">Crear Odontologo</a>
    </div>
</div>
                        ...
                        <?php foreach ($datos['odontologos'] as $odontologo) : ?>
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    <a class="btn red"  href="<?php echo "http://localhost/ExamenFinal" . "/odontologo/actualizar/" . $odontologo->id; ?>">Editar</a>
