...
<div class="row s12">
    ...
    <div class="col s6 right-align ">
        <a href="<?php echo "http://localhost/ExamenFinal" ?>/app/views/categoria/registrar.php" class="btn btn-#01579b light-blue darken-4">Crear Categoria</a>
    </div>
</div>
                        ...
                        <?php foreach ($datos['categorias'] as $categoria) : ?>
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <a style="" class="btn red" href="<?php echo "http://localhost/ExamenFinal" . "/categoria/actualizar/" . $categoria->id; ?>">Editar</a>
