...
<div class="row s12">
    <div class="col s6">
        <a href="http://localhost/ExamenFinal/categoria/categoria/listarCategoria" class="btn btn-dark blue darken-1"><i class="material-icons">arrow_back</i></a>
    </div>
</div>
<div class="">
...
<div class="card" style="margin-left: 80px; margin-right: 90px;background-color:#41B5C2;">
    ...
    <div class="container">
        <form action="http://localhost/ExamenFinal/categoria/registrar" method="POST">
