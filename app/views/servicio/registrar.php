...
<div class="row s12">
    <div class="col s6">
        <a href="http://localhost/ExamenFinal/servicio/servicio/listarCategoria" class="btn btn-#1e88e5 blue darken-1"><i class="material-icons">arrow_back</i></a>
    </div>
</div>
<div class="">
...
<div class="card" style="background-color:#41B5C2;margin-left: 80px; margin-right: 90px;">
    ...
    <div class="container">
        <form action="http://localhost/ExamenFinal/servicio/registrar" method="POST">
