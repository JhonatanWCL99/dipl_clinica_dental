...
<div class="row s12">
    ...
    <div class="col s6 right-align ">
        <a href="<?php echo "http://localhost/ExamenFinal" ?>/app/views/paciente/registrar.php" class="btn btn-#01579b light-blue darken-4">Crear Paciente</a>
    </div>
</div>
                        ...
                        <?php foreach ($datos['pacientes'] as $paciente) : ?>
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    <a class="btn red" style="padding-right: 10px;" href="<?php echo "http://localhost/ExamenFinal" . "/paciente/actualizar/" . $paciente->id; ?>">Editar</a>
