...
<div class="row s12">
    ...
    <div class="col s6 right-align ">
        <a href="http://localhost/ExamenFinal/cita/registrar" class="btn btn-#01579b light-blue darken-4">Agendar Nueva Cita</a>
    </div>
</div>
                    ...
                    <?php if (isset($datos['citas'])) { ?>
                        <?php foreach ($datos['citas'] as $cita) : ?>
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    <a class="btn red" href="<?php echo "http://localhost/ExamenFinal" . "/cita/verDetalle/" . $cita->id; ?>">Ver Detalle</a>
