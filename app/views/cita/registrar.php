...
<div class="row s12">
    <div class="col s6">
        <a href="http://localhost/ExamenFinal/cita/cita/listarcita" class="btn btn-#1e88e5 blue darken-1"><i class="material-icons">arrow_back</i></a>
    </div>
</div>
<!-- <h4 class="center-align">Registrar Cita</h4> -->
<form action="http://localhost/ExamenFinal/cita/registrar" method="POST">
    <div class="row">
        <div class="col-lg-12">
